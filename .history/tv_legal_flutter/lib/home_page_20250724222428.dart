...
class HomePage extends StatelessWidget {
  ...
  {
    'title': 'RTP Memória',
    'url': 'https://streaming-live.rtp.pt/liverepeater/rtpmem.smil/playlist.m3u8',
    'icon': 'assets/images/rtpmemoria.png',
    'category': 'Públicos'
  },
  {
    'title': 'TV Senado',
        ...
        children: categorias.map((categoria) {
          ...
          return ExpansionTile(
            ...
            children: filtrados.map((canal) {
              return ListTile(
                leading: Image.asset(canal['icon'], width: 40, height: 40, errorBuilder: (_, __, ___) => Icon(Icons.tv)),
